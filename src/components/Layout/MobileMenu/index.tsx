...
const MobileMenu = ({
  ...
  const menuLinks: MenuLink[] = [
    ...
    {
      href: '/discover/anime',
      content: intl.formatMessage(menuMessages.anime),
      svgIcon: <FireIcon className="h-6 w-6" />,
      svgIconSelected: <FilledFireIcon className="h-6 w-6" />,
      activeRegExp: /^\/discover\/anime$/,
    },
    {
      href: '/discover/documentales',
      content: intl.formatMessage(menuMessages.documentales),
      svgIcon: <DocumentTextIcon className="h-6 w-6" />,
      svgIconSelected: <FilledDocumentTextIcon className="h-6 w-6" />,
      activeRegExp: /^\/discover\/documentales$/,
    },
    {
      href: '/discover/conciertos',
      content: intl.formatMessage(menuMessages.conciertos),
      svgIcon: <MusicalNoteIcon className="h-6 w-6" />,
      svgIconSelected: <FilledMusicalNoteIcon className="h-6 w-6" />,
      activeRegExp: /^\/discover\/conciertos$/,
    },
    {
      href: '/requests',
